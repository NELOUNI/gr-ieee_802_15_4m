...
# Title: IEEE 802.15.4 Transceiver using OQPSK ieee802_15_4_oqpsk_phy_0
...
try:
        subprocess.call('ps auxw | grep -ie \'listenSlave ncat tee\' | awk \'{print $2}\' | xargs sudo kill -9', shell=True) #FIXME ps -all or ps aux
...
class transceiver_OQPSK_Slave(gr.top_block, Qt.QWidget):
	...
	if self.no_usrp:
		...
		## Using files instead of USRPs
	        ...
	        self.blocks_file_sink_Master = blocks.file_sink(gr.sizeof_gr_complex*1, (os.getcwd()+"/utils/slaveFileSink"), False)
